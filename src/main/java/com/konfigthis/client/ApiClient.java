...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.unstructured.io";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "unstructured-api-key"));
    ...
    private void init() {
        ...
        setUserAgent("Konfig/0.0.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.unstructured.io)
